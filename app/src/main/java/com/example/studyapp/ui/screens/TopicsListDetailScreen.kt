...
import com.example.studyapp.navigation.TopicPlaceholderRoute
import com.example.studyapp.navigation.TopicRoute
import com.example.studyapp.navigation.TopicsRoute
import com.example.studyapp.ui.viewmodels.TopicViewModel
import com.example.studyapp.ui.viewmodels.Topics2PaneViewModel
import kotlinx.coroutines.launch
import kotlin.math.max


fun NavGraphBuilder.topicsListDetailScreen() {
    composable<TopicsRoute> {
        TopicsListDetailScreen()
    }
}

@Composable
internal fun TopicsListDetailScreen(
    viewModel: Topics2PaneViewModel = hiltViewModel(),
...
internal fun TopicsListDetailScreen(
    ...
    fun onTopicClickShowDetailPane(topicId: Int) {
...
internal fun TopicsScreen(
    ...
    val selectedTopicId by viewModel.selectedSubtopicId.collectAsStateWithLifecycle()
    val navigationType: StudyAppContentType
